 ...
 * cada metodo se encarga de crear un arreglo en formato JSON con su propia estructura la cual se debe respetar para su
 * adecuado funcionamiento, ya que la libreria amcharts funciona solo con arreglos en formato JSON y para su uso se
 * implementa JQUERY y sus metodos de AJAX. los archivos javascript de estos metodos se encuentran en
 * js/default/amcharts/report_graphics.js. esta clase solo se encargara de detallar como se deben construir los arreglos
 * en JSON de parte del servidor para posteriormente ser devueltos a las funciones encargadas de pintar el grafico.
 * 
  ...
  public function table($tipo_tabla) {
    ...
    switch ($tipo_tabla) {
      case 'generate_simple_table':
        //Datos que equivales al retorno de un $query->result();
        $arreglo_datos = array(
          array(
            celda_personalizada('50', $celda_roja),
            'La dorada', 'CRA 4A #12-50',
            celda_personalizada('968573604', $celda_verde),
            '2003-09-01', '11:50:20',
            celda_personalizada('yidarraga', $celda_amarilla),
            'D'
          ),
          array(
            celda_personalizada(12, $celda_roja),
            'Cali 3',
            'CRA 10A #56-50',
            celda_personalizada('7478956', $celda_verde),
            '2003-10-10',
            '12:50:21',
            celda_personalizada('yidarraga', $celda_amarilla),
            'D'
          ...
          array(
            celda_personalizada(34, $celda_roja),
            'Palmira',
            'CALL 29 # 26-36',
            celda_personalizada('78945-87865', $celda_verde),
            '2009-01-01', '11:50:22',
            celda_personalizada('hfg', $celda_amarilla),
            'N'
          ),
          array(
            celda_personalizada(13, $celda_roja),
            'Tulua', 'CRA 27 #01-50',
            celda_personalizada('3128214578', $celda_verde),
            '2003-10-21',
            '07:10:58',
            celda_personalizada('ncruz', $celda_amarilla),
            'D'
          )
        );
        //fin datos simulados
        ...
        // la celda personalizada es opcional
        $titulos_columnas = array(
          celda_personalizada('Codigo', $celda_roja),
          celda_personalizada('Nombre', $celda_verde),
          celda_personalizada('Direccion', $celda_amarilla),
          celda_personalizada('Telefono', $celda_verde),
          celda_personalizada('Fecha Creacion', $celda_roja),
          celda_personalizada('Hora creacion', $celda_verde),
          celda_personalizada('Usuario Edicion', $celda_amarilla),
          celda_personalizada('Tipo de Nomina', $celda_roja)
        );
      ...
      case 'generate_simple_table_puntero':
        ...
        $arreglo_datos->resultado1 = (object) array(
              'codigo' => 28,
              'nombre' => 'La dorada',
              'direccion' => 'CRA 4A #12-50',
              'telefonos' => '7478956',
              'feccrea' => '2003-09-01',
              'horacre' => '11:50:20',
              'usrmodi' => 'yidarraga',
        ...
        $arreglo_datos->resultado2 = (object) array(
              'codigo' => 6,
              'nombre' => 'Cali 3',
              'direccion' => 'CRA 10A #56-50',
              'telefonos' => '968573604',
              'feccrea' => '2003-09-01',
              'horacre' => '11:50:21',
              'usrmodi' => 'yidarraga',
        ...
        $arreglo_datos->resultado3 = (object) array(
              'codigo' => 34,
              'nombre' => 'Palmira',
              'direccion' => 'CALL 29 # 26-36',
              'telefonos' => '922726886-27266879',
              'feccrea' => '2003-09-01',
              'horacre' => '11:50:21',
              'usrmodi' => 'hfg',
              'tipo_nomina' => 'N');

        $arreglo_datos->resultado4 = (object) array(
              'codigo' => 13,
              'nombre' => 'Tulua',
              'direccion' => 'CRA 27 #01-50',
              'telefonos' => '7452159',
              'feccrea' => '2003-10-01',
              'horacre' => '17:50:21',
              'usrmodi' => 'Sistemas',
        ...
        foreach ($arreglo_datos as $datos) {
          ...
          $puntero->$key = array(
            celda_personalizada($datos->codigo, $celda_roja),
            celda_personalizada('Nombre', $celda_verde),
            $datos->direccion,
            celda_personalizada($datos->telefonos, $celda_amarilla),
            celda_personalizada($datos->feccrea, $celda_roja),
            celda_personalizada($datos->horacre, $celda_verde),
            $datos->usrmodi,
            celda_personalizada($datos->tipo_nomina, $celda_amarilla)
          );
        }
        $puntero->titulos = array(
          'Codigo',
          'Nombre',
          'Direccion',
          'Telefono',
